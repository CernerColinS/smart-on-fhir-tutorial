...
function getSecurityExtensionsFromWellKnownJson(baseUrl, requestOptions) {
  ...
  console.log(`Well known JSON baseUrl: ${baseUrl}`);
  console.log(`Well known JSON requestOptions: ${requestOptions}`);
  ...
  return fetchWellKnownJson(baseUrl, requestOptions).then(function (meta) {
    ...
    console.log("Well known JSON meta response");
    console.log(meta);
  ...
  return lib_1.fetchConformanceStatement(baseUrl, requestOptions).then(function (meta) {
    ...
    if (extensions) {
      extensions.forEach(function (ext) {
        console.log("Paring extensions from conformance");
        console.log(`ext.url: ${ext.url}`);
        console.log(`ext.valueUri: ${ext.valueUri}`);
        if (ext.url === "register") {
...
function getSecurityExtensions(env, baseUrl) {
  ...
  console.log("Getting them security extensions");
  return any([{
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            _context.next = 19;
            console.log("PREPARING TO GET SMART_KEY");
            return storage.get(settings_1.SMART_KEY);
          ...
          case 22:
            ...
            console.log("SETTING SMART_KEY");
            _context.next = 28;
            return storage.set(settings_1.SMART_KEY, stateKey);

          case 28:
            console.log("SMART_KEY SHOULD NOW BE SET");
          ...
          case 41:
            _context.next = 43;
            console.log("ENTERING getSecurityExtensions");
            return getSecurityExtensions(env, serverUrl);

          case 43:
            console.log("EXITING getSecurityExtensions");
  ...
  _regenerator.default.mark(function _callee2(env) {
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            console.log("Entering completeAuth");
            url = env.getUrl();
            ...
            console.log(authErrorDescription);
            if (key) {
              _context2.next = 11;
              break;
            }
          ...
          case 18:
            ...
            console.log("complete was not found in URL params");
